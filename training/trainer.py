...
from data.dataset import prepare_eval_features
from data.vietnamese_utils import VietnameseTextProcessor, align_segmentation_offset
from model.modeling import build_model
from .config import TrainingConfig
from .optimizer import build_optimizer, build_scheduler
from .qa_metrics import compute_metrics
...
def train(config: TrainingConfig) -> None:
    ...
    if valid_dataset is not None:
        from data.data_loader import load_raw_datasets
